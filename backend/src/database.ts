...
function seedGlobalRecipes(): void {
  const recipes: SeedRecipe[] = [
    ...
    { categoryId: 3, userId: null, isPublic: 1, title: 'Chocolate Mousse', description: 'Rich and airy French chocolate mousse with a velvety smooth texture.', servings: 6, prepTime: 30, imageUrl: 'https://images.unsplash.com/photo-1541783245831-57d6fb0926d3?w=800',
